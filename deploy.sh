...
deploy() {
    ...
    echo "  GET  /api/torrents/:id/files - Get streamable files"
    echo "  POST /api/torrents/:id/stream/:file_index - Create stream session"
    echo "  GET  /api/stream/:session_id - Stream content (supports range requests)"
    echo "  GET  /api/streams            - List active streams"
